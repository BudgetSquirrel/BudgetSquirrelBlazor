  ...
  public class StoredProceduresRegistry
  {
    ...
    public static Dictionary<string, string> GetStoredProcedureFiles()
    {
      return new Dictionary<string, string>
      {
        ...
        { "SetBudgetIsFinalized", $"{ScriptsDir}/BudgetPlanning/SetBudgetIsFinalized.sql" },

        /* Funds */
        { "GetAllFundsInFundTreeWithBudget", $"{ScriptsDir}/Funds/GetAllFundsInFundTreeWithBudget.sql" },
        ...
        { "GetLastTimebox", $"{ScriptsDir}/History/GetLastTimebox.sql" },
